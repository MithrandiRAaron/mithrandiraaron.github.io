...
At UW, he is fortunate to be advised by [Prof. Shi Chen](https://foster.uw.edu/faculty-research/directory/shi-chen/){:target="_blank"}, [Prof. Yong-Pin Zhou](https://faculty.washington.edu/yongpin/){:target="_blank"}, and [Prof. Masha Shunko](https://foster.uw.edu/faculty-research/directory/masha-shunko/){:target="_blank"}. His research is rooted in sustainable operations, platform operations and AI infrastructure operations. Methodology-wise, he specifically focuses on stochastic optimization, game theory, dynamic programming, causal inferences and mean-field approaches. He is passionate about addressing complex industry and supply-chain problems with cutting-edge techniques. 
